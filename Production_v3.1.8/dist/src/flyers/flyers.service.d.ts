...
export declare class FlyersService {
    ...
    constructor(prisma: PrismaService, approvalsService: ApprovalsService, pdfService: PdfService, mssqlService: MssqlService);
    ...
    getFilteredActions(userId: string, userRole: UserRole): Promise<{
        id: number;
        name: string;
        validFrom?: string;
        validTo?: string;
    ...
    updatePdfData(id: string, pdfData: Buffer, pdfMimeType: string): Promise<{
        id: string;
        supplierId: string;
        name: string;
        actionId: number | null;
