...
import { LogOut, Package, FileText, CheckCircle, Home, Grid, Tag, Users, Image, Star, HelpCircle, FolderTree, ListChecks } from 'lucide-react';
    ...
    switch (user.role) {
      case 'admin':
        return [
          ...
          { to: '/admin/active-flyers-products', icon: ListChecks, label: 'Produkty v letácích' },
