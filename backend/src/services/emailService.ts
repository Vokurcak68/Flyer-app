...
class EmailService {
  ...
  // Template for flyer submitted for approval
  async sendFlyerSubmittedEmail(
  ...
  // Template for flyer approved
  async sendFlyerApprovedEmail(
    recipientEmail: string,
    recipientName: string,
    flyerName: string,
    approverName: string,
  ...
  // Template for flyer rejected
  async sendFlyerRejectedEmail(
    recipientEmail: string,
    recipientName: string,
    flyerName: string,
    approverName: string,
