...
let BrandsController = class BrandsController {
    ...
    async getLogo(id, res) {
        const brand = await this.brandsService.findOne(id);
        if (!brand.logoData || !brand.logoMimeType) {
            throw new common_1.NotFoundException('Brand logo not found');
        }
...
], BrandsController.prototype, "getLogo", null);
__decorate([
    (0, common_1.Get)(':id'),
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
    __param(0, (0, common_1.Param)('id')),
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [dto_1.CreateBrandDto]),
    __metadata("design:returntype", void 0)
