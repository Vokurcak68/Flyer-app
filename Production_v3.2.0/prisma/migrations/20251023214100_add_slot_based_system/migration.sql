-- Drop existing table if it exists from previous failed migration attempt
DROP TABLE IF EXISTS "flyer_page_slots" CASCADE;
...
-- DropTable flyer_page_products (replaced by slots)
...
-- Drop enums if they exist from previous failed migration
DROP TYPE IF EXISTS "SlotType";
DROP TYPE IF EXISTS "PromoSlotSize";
