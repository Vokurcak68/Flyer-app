...
let CategoriesController = class CategoriesController {
    ...
    updateSubcategory(subcategoryId, dto) {
...
__decorate([
    ...
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, dto_1.CreateSubcategoryDto]),
    __metadata("design:returntype", void 0)
], CategoriesController.prototype, "createSubcategory", null);
__decorate([
    (0, common_1.Put)('subcategories/:subcategoryId'),
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard, roles_guard_1.RolesGuard),
    (0, roles_decorator_1.Roles)('admin'),
...
__decorate([
    (0, common_1.Delete)('subcategories/:subcategoryId'),
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard, roles_guard_1.RolesGuard),
    (0, roles_decorator_1.Roles)('admin'),
    __param(0, (0, common_1.Param)('subcategoryId')),
    __metadata("design:type", Function),
